...
<template>
  ...
  <div style="display: flex; gap: 32px; justify-content: center; margin: 12px auto">
    ...
    <div style="width: 600px;">
      ...
      <blockquote v-if="isDark" style="font-size: 12px;opacity:0.7;margin-left:0"> 
        Email viewed in dark mode due to system settings. Most clients show it in light mode. Disable dark mode for preview.
      </blockquote>
