...
This page demonstrates how the layout behaves when there are no headings to generate a table of contents from. The content should have more horizontal space available.
...
_This page should display with a wider content area since there's no table of contents._
