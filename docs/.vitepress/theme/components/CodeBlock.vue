...
<template>
  <button bg-transparent block w-full f-text-2xs @click="() => copy(code)">
    <code
      f-px-xs lh="[1.3]" whitespace-normal stack py-8 rounded-6 bg="neutral-100 hocus:neutral-200 data-active:green" text-left outline="solid 1 offset--1 neutral/10 dark:white/10 data-active:green-600" data-active:text-white
